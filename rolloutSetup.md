...
```
10. Create a commit message (Create flag.js) and select "Commit directly to the `initRollout` branch." radio button. The file and its directory path should look similar to the picture below. Click "Commit new file."
