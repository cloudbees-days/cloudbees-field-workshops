...
>NOTE: It is considered a best practice to create and manage all of your CloudBees CI jobs in folders. Organizing your Jenkins jobs in folders provides better performance by limiting the number of items on any one page, allows more granular security by configuring RBAC at the folder, level and enables the easy migration of workload to other controllers using CloudBees' **Move/Copy/Promote** feature.
...
>NOTE: Only a subset of the available job types are available when creating a new item in the **pipelines** folder. This is made possible with the CloudBees' Folders Plus feature that allows you to restrict the types of jobs that can be created within a folder.
