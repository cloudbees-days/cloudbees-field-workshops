...
5. On the next screen, select the **Credentials** with the ***GitHub PAT from JCasC - username/password*** description created - this credential was created by your Core CasC bundle applied to your Team Master.
...
7. Next, under the **Behaviors** section, click the **Add** button, select **Filter by name (with wildcards)** under **- Within repository -** and then enter ***master*** as an **Include** so that will be the only branch that gets scanned and built. <p><img src="images/behaviors-filter-branch-by-name.png" width=800/>
