...
6. Next, under the **Behaviors** section, click the **Add** button, select **Filter by name (with wildcards)** and then enter ***master*** as an **Include** so that will be the only branch that gets scanned and built. <p><img src="images/behaviors-filter-by-name.png" width=600/>
