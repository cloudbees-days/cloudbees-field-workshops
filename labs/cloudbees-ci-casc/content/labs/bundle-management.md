...
11. Once you have finished reviewing the changed files, click on the **Conversation** tab of the **Bundle Management** pull request, scroll down and click the green **Merge pull request** button and then click the **Confirm merge** button.
