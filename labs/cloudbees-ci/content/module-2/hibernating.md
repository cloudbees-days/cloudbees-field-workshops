...
>NOTE: More specifically, hibernation of Managed Controllers is achieved by setting the number of Kubernetes replica sets of the Kubernetes Statefulset backing your Managed Controller to zero.
