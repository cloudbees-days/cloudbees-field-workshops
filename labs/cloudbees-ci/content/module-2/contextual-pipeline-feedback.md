...
4. Navigate back to the **simple-maven-app** Multibranch Pipeline on your CloudBees CI ***managed controller***, click on the **Pull Requests** tab and once the *PR-1* job completes navigate to the [CloudBees Workshops Slack workspace](https://app.slack.com/client/T010A455W77/) and you will receive a new Slackbot direct message from the CloudBees CI Bot. ![Slack build message](slack-build-msg.png?width=50pc)
