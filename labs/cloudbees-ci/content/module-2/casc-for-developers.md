...
8. The updated CasC bundle for your CloudBees CI *managed controller* will install the `cloudbees-slack` plugin and update the configuration to match what is in the `main` branch of you `cloudbees-ci-config-bundle` repository and you will see the **CloudBees Slack Integration** added to the  **Managed Jenkins** screen.
