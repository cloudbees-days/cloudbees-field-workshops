...
9.  Navigate back to the **simple-maven-app** Multibranch Pipeline project and you will see that there is now a **main** branch job. ![Maven main job](maven-main-job.png?width=50pc)
