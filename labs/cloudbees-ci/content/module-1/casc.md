...
11. Navigate back to your CloudBees CI managed controller and then to the **update-config-bundle** Multibranch Pipeline project under the **template-jobs** folder. ![Scan Log](nav-to-core-config-bundle-job.png?width=50pc)
...
13. Among other configuration changes, you will now see a link for **Pipeline Polices** in the left navigation menu and an updated system message for your CloudBees CI managed controller. ![Scan Log](casc-update-applied.png?width=50pc)
