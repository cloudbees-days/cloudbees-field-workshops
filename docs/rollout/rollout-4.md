...
Target groups let you define groups of users based on user priorities or device attributes. CloudBees Rollout includes built-in targeting using the format `rox.<attribute name>`.
